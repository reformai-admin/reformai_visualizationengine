...
import { buildConstraintHierarchyBlock, INJECTED_ITEM_BLOCK_HEADER, } from '../../../prompts/balanced_v4_1/visualization.constants.js';
import { buildVisualizationPrompt, buildInfluencePrompt, } from '../../../prompts/balanced_v4_1/visualization.prompt.js';
...
export const generateVisualization = async (params) => {
    ...
    if (injectedItems.length > 1) {
        throw new Error(`balanced_v4_1 supports a maximum of 1 injected item. ` +
