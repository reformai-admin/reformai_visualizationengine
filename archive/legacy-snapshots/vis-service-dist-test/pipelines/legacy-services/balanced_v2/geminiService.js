...
import { buildVisualizationPrompt, buildInfluencePrompt, buildFurniturePrompt } from '../../../prompts/balanced_v2/visualization.prompt.js';
...
export const generateVisualization = async (params) => {
    ...
    // Final structural anchor — same sandwich structure as balanced_v1 and improved
