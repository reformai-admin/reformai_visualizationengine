...
export const buildRenovationAnchorsBlock = (selections) => {
    ...
    lines.push('——', '');
    lines.push('ANCHOR SELF-CHECK — before proceeding to style instructions: confirm each active anchor has been', 'applied to its target surface. If any anchor was skipped, apply it before reading further.', 'If an anchor surface was not visible, confirm no component was introduced.');
    return lines.join('\n');
};
//# sourceMappingURL=renovation-anchors.js.map