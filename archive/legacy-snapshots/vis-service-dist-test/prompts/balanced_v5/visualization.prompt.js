...
// ============================================================
import { TEMPLATE_VERSION, BALANCED_V5_STRUCTURAL_PART, BALANCED_V5_STYLE_TEMPLATE, INJECTED_ITEM_AUDIT_TEXT, buildMoodboardScopeBlock, V5_MOODBOARD_INFLUENCE_STATEMENT, INFLUENCE_PRESET_STYLE_ONLY, DEFAULT_USER_REQUEST, } from './visualization.constants.js';
...
export const sanitizeApertureLook = (raw) => {
    ...
    console.warn(`[balanced_v5] aperture_look is set ("${raw.slice(0, 60)}...") but has no injection point in template v${TEMPLATE_VERSION}. Value is excluded from the rendered prompt.`);
...
export const buildInfluencePrompt = (moodBoardImagesCount, _styleInfluence, // ignored in V5 — no slider; kept for signature compatibility
_stylePresetName) => {
...
export const buildMoodboardBlock = (styleName, stagingDensity, hasMoodboards) => {
    if (!hasMoodboards)
        return '';
