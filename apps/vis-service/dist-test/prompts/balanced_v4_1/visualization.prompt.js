...
// ============================================================
import { TEMPLATE_VERSION, BALANCED_V4_1_STRUCTURAL_PART, BALANCED_V4_1_STYLE_TEMPLATE, INJECTED_ITEM_AUDIT_TEXT, INFLUENCE_PRIORITIZE_PRESET_STYLE, INFLUENCE_PRIORITIZE_MOOD_BOARD, INFLUENCE_BALANCE_STYLE_AND_MOOD_BOARD, INFLUENCE_PRESET_STYLE_ONLY, DEFAULT_USER_REQUEST, } from './visualization.constants.js';
...
export const sanitizeApertureLook = (raw) => {
    ...
    console.warn(`[balanced_v4_1] aperture_look is set ("${raw.slice(0, 60)}...") but has no injection point in template v${TEMPLATE_VERSION}. Value is excluded from the rendered prompt.`);
