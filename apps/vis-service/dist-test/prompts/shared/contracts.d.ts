...
export type ConstraintHierarchyBuilder = (options: ConstraintHierarchyOptions) => string;
export type RenovationAnchorsBuilder = (selections: ResolvedRenovationSelections) => string;
export type MoodboardScopeBuilder = (styleName: string, stagingDensity: 'low' | 'medium' | 'high') => string;
