...
export const buildAGTEchoBlock = (agt) => {
    if (agt.hard_fact_fields.length === 0)
        return '';
    const lines = [
    ...
    lines.push('An output that contradicts any hard fact above is an architectural compliance failure.');
    return lines.join('\n');
};
//# sourceMappingURL=agt-echo.js.map