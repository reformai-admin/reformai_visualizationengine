import { buildConstraintHierarchyBlock, buildRenovationAnchorsBlock, INJECTED_ITEM_BLOCK_HEADER, } from '../../../prompts/balanced_v5/visualization.constants.js';
import { buildVisualizationPrompt, buildInfluencePrompt, buildMoodboardBlock, } from '../../../prompts/balanced_v5/visualization.prompt.js';
...
export const generateVisualization = async (params) => {
    const { roomType, stylePreset, moodBoardImages, textPrompt, styleInfluence, contractorId, renovationSelectionIds, } = params;
    const { injectedItems, item, hasInjectedItem, shimmedFromFurnitureImage, } = normalizeInjectedItems(params, 'balanced_v5');
    ...
    const constraintHierarchyBlock = buildConstraintHierarchyBlock(injectedItems.length, hasRenovationAnchors);
