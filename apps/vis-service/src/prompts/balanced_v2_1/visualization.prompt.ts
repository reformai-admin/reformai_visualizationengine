...
import {
    ...
    BALANCED_V2_1_PROTOCOL_RIGID_BASE,
    BALANCED_V2_1_PROTOCOL_RIGID_APERTURE_LOCK,
    BALANCED_V2_1_PROTOCOL_SURFACE_ONLY_TRANSFORM,
...
export const buildVisualizationPrompt = (params: BalancedV2_1PromptParams): BuiltBalancedV2_1Prompt => {
