...
4. **Fixed Element Immutability**:
- The following elements are FIXED. They must NOT be added, removed, or relocated under any circumstance:
  - Ceiling lights, pendant lights, recessed lights, sconces, and all built-in light fixtures
  - Windows, skylights, and all architectural openings
  - Doors and doorframes
  - Walls, columns, beams, and structural surfaces
  - Built-in cabinetry, shelving, or millwork attached to the structure
